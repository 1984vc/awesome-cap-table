...
This repository is an OCF 1.2.0 company snapshot. `minicap/` is the source of truth; the README is an explanation, not a second ledger. Keep the example fictional.
...
- YC's example investment is **two separate SAFEs**: $125,000 for a fixed 7% on conversion and $375,000 uncapped with MFN. The other investor's $1,000,000 SAFE has a $15,000,000 post-money cap and no discount. Do not turn these into issued stock until a conversion is explicitly recorded.
...
- If you change the facts in the package, update the short terms table in `README.md` too.
